...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--model', type=str, default='skipganomaly', help='chooses which model to use. skipganomaly or w_skipganomaly')
        ...
        self.parser.add_argument('--tune', type=bool, default=False, help='if we are doing parameter tuning')
        self.isTrain = True
        self.opt = None
